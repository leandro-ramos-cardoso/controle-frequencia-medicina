...
export default async function LocaisPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <form action={createLocation} className="grid grid-cols-1 gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-card sm:grid-cols-2">
      ...
      <div className="space-y-2">
        {locations.map((loc) => (
          <div key={loc.id} className="flex items-center justify-between rounded-2xl border border-slate-200 bg-white p-4 shadow-card">
            <div>
